...
description: XML and JSON are the two most common formats to receive data from the server. Let's take a look at the differences between these two formats in this piece.
