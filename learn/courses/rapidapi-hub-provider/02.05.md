...
![Defining endpoints for your APIs](rapidapi-hub-provider/images/image10.png)
...
![Providing details for the endpoint](rapidapi-hub-provider/images/image11.png)

Next, you will also be able to select the HTTP method and path for your endpoint:

![Creating a REST API endpoint](rapidapi-hub-provider/images/image12.png)
...
![Testing the new endpoint](rapidapi-hub-provider/images/image13.png)

You can also choose to create an example from the response by clicking on the **Create example from response** button:

![Creating example from the response of the new endpoint](rapidapi-hub-provider/images/image14.png)
